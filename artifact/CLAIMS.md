...
cap `142 = 2*13 + (2*4 + 2*37 + 30) + 4`, and modeled cost is exactly emitted
...
- The canonical reviewer route has the principled charged-trace bound `142`.
...
evidence, and principled `142` charged-trace cap are consumed by
