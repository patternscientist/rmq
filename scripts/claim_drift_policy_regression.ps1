...
$fixtures = @(
  ...
  @{ id = "r1r3-compatibility-labeled-weaker-story-control"; relativePath = "README.md"; reject = $false; termId = "forbidden-retired-current-event-vocabulary"; text = "The compatibility theorem says every event is a payload read or bounded word primitive; the current route is readWord-only." },
