...
theorem same_1_8_storeA :
    ([1,2,3,4,5,6,7,8].all fun n => sameSizeAt stA n) = true := by native_decide

theorem same_1_8_storeB :
    ([1,2,3,4,5,6,7,8].all fun n => sameSizeAt stB n) = true := by native_decide

theorem antivac_codes :
    ([1,2,3,4,5,6,7,8].map codesDistinct) = [1,2,5,14,42,132,429,1430] := by
  native_decide
