...
flowchart TD
  ...
  SuccinctRankProposal --> SuccinctSelectTwoLevel
  ...
  SuccinctSelectDenseLocal --> SuccinctSelectProposal["Core.SuccinctSelectProposal"]
...
- `RMQ/Core/SuccinctSelect/TwoLevel.lean`,
  ...
  `RMQ/Core/SuccinctSelect/DenseLocalTables.lean`, and the remaining
  `RMQ/Core/SuccinctSelectProposal.lean` root, all preserving the historical
  `SuccinctSelectProposal` namespace:
